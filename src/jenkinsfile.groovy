https://github.com/aman-0105/jenkins-pipeline.git

/**
 * Jenkins Declarative Pipeline for the Java compilation experiment (Experiment 6).
 * This pipeline pulls the source code from GitHub, compiles it, ru+ns it, and cleans up.
 *
 * Repository:https://github.com/aman-0105/jenkins-pipeline.git
...
pipeline {
    ...
    environment {
        ...
        GIT_REPO = 'https://github.com/aman-0105/jenkins-pipeline.git'
